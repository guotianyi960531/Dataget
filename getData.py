...
def parse_html(response, number):
    try:
        ...
        for i in range(len(job)):
            ...
            cursor.execute(sql, [item['job'], item['salary'],item['city'],item['frequency'],item['duration'],item['company_name'],item['company_scale'],item['advantage']])

            print(item)
            with open('result.txt', 'a') as f:
                json_str = json.dumps(item, indent=0)
                f.write(json_str)
...
if __name__ == '__main__':
    ...
    url = 'https://www.shixiseng.com/interns/?keyword=%E6%95%B0%E6%8D%AE%E5%88%86%E6%9E%90&page={}&city=%E5%85%A8%E5%9B%BD'
